...
public class ResourceConfig extends HashMap<SystemResource.RESOURCE, String> {
	...
	public static ResourceConfig generate() {
		...
		cfg.put(RESOURCE.NET_RX_BYTES,     String.valueOf(UnimanageDataUtil.getRandomLong(5 * GB)));
		cfg.put(RESOURCE.NET_TX_BYTES,     String.valueOf(UnimanageDataUtil.getRandomLong(5 * GB)));

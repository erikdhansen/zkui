...
public class Statistics extends HashMap<LteStatistics.STAT, String>{
	...
	public Statistics() {
		this.put(STAT.LTE_ERAB_SSR_ATTEMPT_ALL, String.valueOf(UnimanageDataUtil.getRandomLong(9999999)));
		...
		this.put(STAT.LTE_HANDOVER_ATTEMPTS_IN, String.valueOf(UnimanageDataUtil.getRandomLong(100000)));
		this.put(STAT.LTE_HANDOVER_ATTEMPTS_OUT, String.valueOf(UnimanageDataUtil.getRandomLong(100000)));

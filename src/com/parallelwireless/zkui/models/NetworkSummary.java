...
public class NetworkSummary {
	...
	private void createDonutPieChart() {
		...
		allDevs.put(NetworkDeviceStatusBucket.getLabel(NetworkDevice.TYPE.LAC), getUnicloudCount());
		...
		netDevMap.put(NetworkDeviceStatusBucket.getLabel(NetworkDevice.TYPE.LAC), uniclouds);
	...
	private void createDrilldownPieChart() {
		...
		allDevices.put(TYPE.LAC, getUnicloudCount());
		...
		networkDevices.add(new NetworkDeviceStatusBucket(NetworkDevice.TYPE.LAC, NetworkDevice.STATUS.up, uniclouds.get("up")));
		networkDevices.add(new NetworkDeviceStatusBucket(NetworkDevice.TYPE.LAC, NetworkDevice.STATUS.down, uniclouds.get("down")));
